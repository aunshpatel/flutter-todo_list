                ...
                Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Flexible(
                          child: Text("The Todo List is a leading application that specializes in helping its users to add, update and delete various daily tasks and ease their lives.", style: kLightSize18Text),
                        )
                      ],
                    ),
                  ],
